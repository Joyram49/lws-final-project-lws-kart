...
function UpdateForm({ shippingInfo, onClose, setIsloading }) {
  const [updatedProfile, setUpdatedProfile] = useState(shippingInfo);
    ...
    >
      <div className='w-full flex gap-x-4 justify-between px-5'>
        <div className='w-full flex flex-col '>
          ...
          <input
            ...
            value={updatedProfile?.shipping_address?.name}
        ...
        <div className='w-full flex flex-col'>
          ...
          <input
            ...
            name='contact'
            className='w-full ring-1 ring-slate-800/10 shadow-sm border-none rounded-sm pl-2 py-1 text-slate-800 font-roboto'
            value={updatedProfile?.shipping_address?.contact}
            onChange={handleChange}
          />
        </div>
      </div>
      ...
      <div className='w-full flex flex-col px-5'>
        ...
        <input
          ...
          name='street_address'
          className='w-full ring-1 ring-slate-800/10 shadow-sm border-none rounded-sm pl-2 py-1 text-slate-800 font-roboto'
          value={updatedProfile?.shipping_address?.street_address}
          onChange={handleChange}
        />
      </div>
      ...
      <div className='w-full flex justify-between gap-x-4 px-5'>
        <div className='w-full flex flex-col'>
          ...
          <input
            ...
            name='city'
            className='w-full ring-1 ring-slate-800/10 shadow-sm border-none rounded-sm pl-2 py-1 text-slate-800 font-roboto'
            value={updatedProfile?.shipping_address?.city}
            onChange={handleChange}
          />
        </div>
        <div className='w-full flex flex-col'>
          ...
          <input
            ...
            name='postal_code'
            className='w-full ring-1 ring-slate-800/10 shadow-sm border-none rounded-sm pl-2 py-1 text-slate-800 font-roboto'
            value={updatedProfile?.shipping_address?.postal_code}
            onChange={handleChange}
          />
        </div>
      </div>
      <div className='w-full flex flex-col px-5'>
        ...
        <input
          ...
          name='country'
          className='w-full ring-1 ring-slate-800/10 shadow-sm border-none rounded-sm pl-2 py-1 text-slate-800 font-roboto'
          value={updatedProfile?.shipping_address?.country}
          onChange={handleChange}
        />
      </div>
